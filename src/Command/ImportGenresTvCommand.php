...
#[AsCommand(
    name: 'app:import-genres-tv',
    description: 'Import tv genres from TMDB',
)]
class ImportGenresTvCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, 'https://api.themoviedb.org/3/genre/tv/list?api_key='.$API_KEY.'&language=fr-FR');
